...
/**
 * 前后端通信相关的配置
 * @see [参考](https://open-doc.modstart.com/ueditor-plus/backend.html)
...
return [
    ...
    'audioPathFormat' => '/uploads/media/{yyyy}{mm}/{yy}{mm}{dd}_{hh}{ii}{ss}_{rand:4}',  // 文件保存路径
    'audioUrlPrefix' => '',  // 音频访问路径前缀
    'audioMaxSize' => 10*1024*1024,  // 上传大小限制, 单位B, 默认10MB, 注意修改服务器的大小限制
    'audioAllowFiles' => ['.mp3'],  // 允许上传的文件类型
